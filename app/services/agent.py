...
- Everyday words only, the ones people actually speak. Plain Hindi/Hinglish over formal or literary Hindi (आप कैसे हैं, not आपकी क्या सेवा कर सकता हूँ), plain English over business English (no "solutions", "leverage", "utilise", "as per", "kindly", "revert", "do the needful"). A shopkeeper explaining something to a neighbour, not a brochure being read out.
